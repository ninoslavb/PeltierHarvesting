...
{
     OSCCONbits.IRCF = 0b0111;              // Internal RC Oscillator Frequency Select - HFINTOSC (8MHz)
     //OSCCONbits.IRCF = 0b1011;            // Internal RC Oscillator Frequency Select - HFINTOSC (1MHz)
     //OSCCONbits.IRCF = 0b0111;            // Internal RC Oscillator Frequency Select - HFINTOSC (500kHz)
